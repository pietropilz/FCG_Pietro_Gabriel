...
//Tipo de camera utilizada. Pode ser modificada ao apertar tecla C.
...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 800, "Trabalho final FCG", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    //trecho que tá no lab 5, mas estraga modo de desenho já pronto
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 projection = projection_game(g_UsePerspectiveProjection, g_ScreenRatio);
